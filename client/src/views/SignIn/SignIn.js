...
const SignIn = props => {
  ...
  const handleSignIn = event => {
    ...
    AuthService.login(formState.values).then(r => {
      setUser(r)
      history.push('/');
    }).catch(err => {
        ...
        <CardContent>
          ...
          >
            <div style={{ textAlign: 'center' }}>
              ...
              <RadioGroup row name="type" value={formState.values.type} onChange={handleChange}>
                <FormControlLabel
                  value="apoderado"
            ...
            <TextField
              ...
              fullWidth
              helperText={
                hasError('dni') ? formState.errors.dni[0] : null
              }
